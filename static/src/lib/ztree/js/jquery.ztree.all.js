  ...
  var settings = {}, roots = {}, caches = {},
    ...
    _consts = {
      ...
      usericon:{
        ...
        OPEN:"tree-minus",
        //父节点图标
         FATHSERNODE: 'iconfont icon-fuhecailiao iconfolder',

         FATHSERNODEOPEN:'iconfont icon-fuhecailiao iconfolder',
      
        //子节点图标
         CHILDRENNODE: "iconfont icon-changguigongzuo iconfolder",
        ...
        //编辑图标
         EDIT: "iconfont icon-bianji iconEdit",
        //移除图标
         REMOVE: "iconfont icon-guanbi iconRemove",
        //增加节点图标
    ...
    view = {
      ...
      makeNodeIcoClass: function (setting, node) { //add 修改文件和文件夹图标
        var icoCss = ["ico"];
        if (!node.isAjaxing) {
          var isParent = data.nodeIsParent(setting, node);
          ...
          if (isParent) {
            ...
            icoCss.push(node.open ? consts.usericon.FATHSERNODEOPEN : consts.usericon.FATHSERNODE);
          } else {
            //单独文件图标 add
            icoCss = [];
            icoCss.push(consts.usericon.CHILDRENNODE);
          }
        }
        // return consts.className.BUTTON + " " + icoCss.join('_');
        return consts.className.BUTTON + " " + icoCss.join(' ');
      },
      ...
      replaceIcoClass: function (node, obj, newName) {
        ...
        //动态改变折叠样式  add
        if(obj.hasClass("fa-folder") == true){
      ...
      replaceSwitchClass: function (node, obj, newName) {
        ...
        //动态改变折叠样式  add
        // if(obj.hasClass("tree-plus") == true){
        //   obj.removeClass("tree-plus").addClass("tree-minus");
        //   return;
        // }else{
        //   obj.removeClass("tree-minus").addClass("tree-plus");
        //   return;
        // };
...
(function ($) {
  ...
  var _consts = {
    ...
    _view = {
      ...
      makeChkClass: function (setting, node) { //add checkbox样式
  ...
  var _consts = {
    ...
    _view = {  //add 修改编辑图标 
      addEditBtn: function (setting, node) {
        ...
        var aObj = $$(node, consts.id.A, setting),
          editStr = "<span class='" + consts.className.BUTTON  + " " + consts.usericon.EDIT +  " edit' id='" + node.tId + consts.id.EDIT + "' title='" + tools.apply(setting.edit.renameTitle, [setting.treeId, node], setting.edit.renameTitle) + "' treeNode" + consts.id.EDIT + " style='display:none;'></span>";
        aObj.append(editStr);
      ...
      addRemoveBtn: function (setting, node) {
        ...
        var aObj = $$(node, consts.id.A, setting),
          removeStr = "<span class='" + consts.className.BUTTON + " " + consts.usericon.REMOVE +  " remove' id='" + node.tId + consts.id.REMOVE + "' title='" + tools.apply(setting.edit.removeTitle, [setting.treeId, node], setting.edit.removeTitle) + "' treeNode" + consts.id.REMOVE + " style='display:none;'></span>";
